...
def setup_acm(width=1, *, height=None, span=False, l=0.15, r=0.98, t=0.98, b=0.17, params={}):
    figsize = get_figsize(width, height, span)
...
def setup_large(width=1, *, height=None, span=False, l=0.15, r=0.98, t=0.98, b=0.17, params={}):
    figsize = get_figsize(width, height, span)
